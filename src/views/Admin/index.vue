                  ...
                  <ul class="dropdown-menu dropdown-navbar">
                    <li>
                      <a href="#" class="clearfix">
                        <img
                          src="ace/assets/images/avatars/avatar.png"
                          class="msg-photo"
                          alt="Alex's Avatar"
                        />
                        <span class="msg-body">
                    ...
                    <li>
                      <a href="#" class="clearfix">
                        <img
                          src="ace/assets/images/avatars/avatar3.png"
                          class="msg-photo"
                          alt="Susan's Avatar"
                        />
                        <span class="msg-body">
                    ...
                    <li>
                      <a href="#" class="clearfix">
                        <img
                          src="ace/assets/images/avatars/avatar4.png"
                          class="msg-photo"
                          alt="Bob's Avatar"
                        />
                        <span class="msg-body">
                    ...
                    <li>
                      <a href="#" class="clearfix">
                        <img
                          src="ace/assets/images/avatars/avatar2.png"
                          class="msg-photo"
                          alt="Kate's Avatar"
                        />
                        <span class="msg-body">
            ...
            <li class="light-blue dropdown-modal">
              <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                <img
                  ...
                  src="/ace/assets/images/avatars/user.jpg"
                  alt="Jason's Photo"
                />
        ...
        <ul class="nav nav-list">
          ...
          <li class="">
            <a href="#" class="dropdown-toggle">
              <i class="menu-icon fTablesa fa-list"></i>
          ...
          <li class="">
            <a href="#" class="dropdown-toggle">
              <i class="menu-icon fTablesa fa-list"></i>
              <span class="menu-text"> 图书借阅归还 </span>
          ...
          <li class="">
            <a href="#" class="dropdown-toggle">
              <i class="menu-icon fTablesa fa-list"></i>
              <span class="menu-text"> 读者评论管理 </span>
          ...
          <li class="">
            <a href="#" class="dropdown-toggle">
              <i class="menu-icon fTablesa fa-list"></i>
              <span class="menu-text"> 图书类别管理 </span>
        ...
        <div class="footer-inner">
          <div class="footer-content">
            <span class="bigger-120">
              <span class="blue bolder">XXX</span>
              图书管理系统 &copy; 2099-2099
            </span>
